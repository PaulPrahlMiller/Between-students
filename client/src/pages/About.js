...
const TeamPhoto = require('../../src/assets/future-college-student.jpg')
...
{/*2 profolio*/}
        <div className="aboutcontainer">
            <div className="aboutphoto1">
                {<img src={TeamPhoto_Zijie} className="aboutphoto2" alt="about_photo" />}
            </div>
            <div className="abouttext1">
...
{/*3 profolio*/}
        <div className="aboutcontainer">
            <div className="aboutphoto3">
                {<img src={TeamPhoto_Meron} className="aboutphoto3" alt="about_photo" />}
            </div>
            <div className="abouttext1">
...
{/*4 profolio*/}
        <div className="aboutcontainer">
            <div className="aboutphoto1">
                {<img src={TeamPhoto_Frank} className="aboutphoto2" alt="about_photo" />}
            </div>
            <div className="abouttext1">
